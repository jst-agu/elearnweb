     ...
     min-h-[650px] relative '>
      ...
      md:pr-16 xl:pr-40 md:py-0'>
        <div className='text-center md:text-left space-y-6'>
            ...
            uppercase text-2xl'>100% Satisfaction Guarantee
            </motion.p>
            <motion.h1
            ...
            lg:text-6xl !leading-tight '>Find Your Perfect 
            ...
            initial='hidden'
            animate='visible' 
            >We help you find the best tutors for 1-on-1 tutoring.
                Its completely free and private!
            </motion.p>
            {/* button section */}
        <motion.div
